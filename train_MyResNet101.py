# -*- coding: utf-8 -*-
# 训练ResNet101（当时训练ResNet101是在Google Colaboratory上训练的）
...
model.compile(optimizer=keras.optimizers.Adam(),
              loss=keras.losses.SparseCategoricalCrossentropy(from_logits=False), metrics=["acc", keras.metrics.SparseTopKCategoricalAccuracy(k=2, name='top2_acc')])
EPOCHS = 200
INITIAL_EPOCH = 0
...
csv_filename = path+'/ResNet101_training_log.csv'
